...
install_services() {
    ...
    echo "Starting the installation of systemd services..."

    echo "1. Delete old services and related files..."
    ...
    echo "- Old binary files are removed."

    echo "2. Installed the script and created the Limit IP service..."
...
EOF
    ...
    echo "3. Installing the script and creating the Quota Limit service..."
    mkdir -p /etc/xray/
...
EOF
    ...
    echo "4. Reloading systemd and enabling all timers..."
    ...
    echo "All services are successfully installed and activated."
}
